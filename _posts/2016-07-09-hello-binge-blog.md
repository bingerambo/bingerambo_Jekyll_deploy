...
* 感谢 __[Hux]__ 的博客主题和开源项目（这儿访问他的博客[@Hux Blog](http://huangxuan.me/)），其主题风格采用了Clean Blog，我在其基础上，增加了categories、archives等功能，取消了知乎、新浪微博、FaceBook分享。这样，便有了你现在所看到的页面。。
