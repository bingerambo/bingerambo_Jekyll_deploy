...
* 感谢__[Hux]__ 的博客主题和开源项目（这儿访问他的博客[@Hux Blog](http://huangxuan.me/)），其主题风格采用了Clean Blog，我在其基础上，增加了categories、archives等功能，取消了知乎、新浪、FaceBook分享，这样，便有了你现在所看到的页面。。

* 特别感谢__[Tuantuan.G]__，在百忙之余，提供了丰富的图片素材。让我方便修图，配图攒文。同时，也对小站的完善提出了宝贵建议，并分享其原创作品。
